...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        self.data_ingestion_config = os.path.join(
            training_pipeline_config.artifact_dir, training_pipeline.DATA_INGESTION_DIR_NAME
        )
        self.feature_store_file_path = os.path.join(
            self.data_ingestion_config, training_pipeline.DATA_INGESTION_FEATURE_STORE_DIR, training_pipeline.FILE_NAME
        )
        ...
        self.testing_file_path = os.path.join(
            self.data_ingestion_config, training_pipeline.DATA_INGESTION_INGESTED_DIR,
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.overfitting_underfitting_threshold: float = training_pipeline.MODEL_TRAINET_OVER_FITTING_UNDER_FITTING_THRESHOLD